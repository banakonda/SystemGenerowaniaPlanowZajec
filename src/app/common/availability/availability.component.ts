...
export class AvailabilityComponent {
  @Input() availabilityTime: Availability;
  selected: 'monday' | 'tuesday' | 'wednesday' | 'thursday' | 'friday' = 'monday';
  ...
  setAvailabilityTo(value: boolean, type: string): void {
    this.availabilityTime[type].fill(value);
  }
}
